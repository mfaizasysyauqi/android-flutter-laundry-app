// File: lib/presentation/screens/admin_voucher_details_screen.dart
// Berisi layar untuk menampilkan detail voucher dari perspektif admin.
...
// Widget layar untuk detail voucher admin
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            context
                .go('/admin-voucher-list-screen'); // Kembali ke daftar voucher
          },
        ),
        title: Text(
          'Voucher Details',
